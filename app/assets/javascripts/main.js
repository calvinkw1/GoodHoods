...
$(document).ready(function() {
  ...
  $("#map-canvas").on("click", function(e) {
    ...
    result = encodeURI("https://maps.googleapis.com/maps/api/geocode/json?address=" + clickLocation +  "&key=" + ENV["GOOGLE_API_KEY"] +  "&z=15");
...
function mapCall() {
  ...
  var url = encodeURI("https://maps.googleapis.com/maps/api/geocode/json?address=" + location + "&key=" + ENV["GOOGLE_API_KEY"]);
